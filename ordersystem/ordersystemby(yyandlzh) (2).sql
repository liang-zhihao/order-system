...
-- Records of business
-- ----------------------------
INSERT INTO `business` VALUES (1, 'ff14', 'ff14', '123456', NULL, NULL, 'Internet', NULL);
INSERT INTO `business` VALUES (2, 'home of sand', 'sand', '123456', NULL, NULL, 'land', NULL);
...
CREATE TABLE `customer`  (
  ...
  INDEX `CustomerID_10`(`CustomerID`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 94697 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of customer
-- ----------------------------
INSERT INTO `customer` VALUES (7, 'xhy', '123456', 'ww', NULL, NULL, NULL, NULL);
...
) ENGINE = InnoDB AUTO_INCREMENT = 82824 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of product
-- ----------------------------
INSERT INTO `product` VALUES (19954, '22323', 'colo', 11.00, '*Detail\n', 0.00, 1, 'Business-1-19954-png');
